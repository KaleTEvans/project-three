...
const resolvers = {
  Query: {
    ...
    popularMovies: () => {
      return fetch(`https://api.themoviedb.org/3/movie/popular?api_key=${apiKey2}&language=en-US&page=1`)
      .then(res => res.json())
    },
    singleMovie: (root, args) => {
      return fetch(`https://api.themoviedb.org/3/search/movie/?api_key=${apiKey2}&language=en-US&query=${args.title}&page=1`)
      .then(res => res.json())
    },
